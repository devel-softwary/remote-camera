...
2. Aprire un'area con nome univoco nel progetto e selezionarla.
...
5. Chiudere l'area per bloccare nuovi scatti e creare una nuova sessione per proseguire in un'altra area.
